...
# El guion largo (EN DASH) es a proposito: el extracto de 2026 usa los dos.
# Si alguien lo "arregla" a guion normal, el periodo deja de detectarse y todo
# el extracto se lee sin fechas.
